...
public class SchemaBuilder {
    ...
    public static Map<String, Object> buildFlatTestsSchema(Map<String, Map<String, Object>> properties, List<String> requiredFields) {
    ...
    public static Map<String, Object> buildSingleTurnSchema() {
        ...
        return buildFlatTestsSchema(properties, List.of(
            "prompt_content", "prompt_expected_response", "prompt_language_code",
    ...
    public static Map<String, Object> buildMultiTurnSchema() {
        ...
        return buildFlatTestsSchema(properties, List.of(
            "test_configuration_goal", "test_configuration_instructions",
            "test_configuration_restrictions", "test_configuration_scenario",
