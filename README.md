...
You can install the Rhesis Java SDK using either **JitPack** (recommended for easy public access) or **GitHub Packages**.

### Option 1: JitPack (Recommended)

JitPack allows you to include the SDK in your projects without needing any complex authentication or tokens.
...
The SDK is also published to GitHub Packages. You'll need to configure your build tool to authenticate with GitHub Packages using a Personal Access Token (PAT) with `read:packages` permission.
