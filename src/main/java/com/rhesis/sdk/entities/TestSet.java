...
public record TestSet(
    ...
    @JsonProperty("test_set_type") @JsonDeserialize(using = TestTypeDeserializer.class) TestType testSetType,
    @JsonProperty("tests") List<Test> tests) implements BaseEntity<TestSet> {
